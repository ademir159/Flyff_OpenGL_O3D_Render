...
bool CreateNativeWin(/*EGLNativeDisplayType nativedisp, */int width, int height, EGLNativeWindowType* nativewin_out)
{
	bool result = true;

	LPCSTR szWindowName = TEXT("OpenGL ES Sample");
	LPCSTR szClassName = TEXT("OGL_CLASS");
	...
	*/
    ...
    if(result)
    {
		...
		*/
		...
		hWnd = CreateWindow(szClassName, szWindowName, m_dwWindowStyle,
